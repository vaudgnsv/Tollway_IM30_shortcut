...
public class TerminalEPSFragment extends Fragment implements View.OnClickListener {
    ...
    public TerminalEPSFragment() {
        super();
    }

    @SuppressWarnings("unused")
    public static TerminalEPSFragment newInstance() {
        TerminalEPSFragment fragment = new TerminalEPSFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_trtminal_eps, container, false);
    ...
    private void initInstances(View rootView, Bundle savedInstanceState) {
        ...
        terminalLabel.setText(Preference.getInstance(getContext()).getValueString(Preference.KEY_TERMINAL_ID_EPS));
        merchantLabel.setText(Preference.getInstance(getContext()).getValueString(Preference.KEY_MERCHANT_ID_EPS));
        traceLabel.setText(Utility.calNumTraceNo(Preference.getInstance(getContext()).getValueString(Preference.KEY_INVOICE_NUMBER_ALL)));
        batchLabel.setText(Utility.calNumTraceNo(Preference.getInstance(getContext()).getValueString(Preference.KEY_BATCH_NUMBER_EPS)));
        tpduLabel.setText(Preference.getInstance(getContext()).getValueString(Preference.KEY_TPDU_EPS));
        niiLabel.setText(Preference.getInstance(getContext()).getValueString(Preference.KEY_NII_EPS));
            ...
            case R.id.terminalBtn:
                ...
                customDialog.setOnClickListener(new CustomDialog.OnClickDialog() {
                    ...
                    public void onClickSave(Dialog dialog, String sEt) {
                        ...
                        Preference.getInstance(getContext()).setValueString(Preference.KEY_TERMINAL_ID_EPS,sEt);
                        dialog.dismiss();
                    }
            ...
            case R.id.merchantBtn:
                ...
                customDialog.setOnClickListener(new CustomDialog.OnClickDialog() {
                    ...
                    public void onClickSave(Dialog dialog, String sEt) {
                        ...
                        Preference.getInstance(getContext()).setValueString(Preference.KEY_MERCHANT_ID_EPS,sEt);
                        dialog.dismiss();
                    }
            ...
            case R.id.traceBtn:
                ...
                customDialog.setOnClickListener(new CustomDialog.OnClickDialog() {
                    ...
                    public void onClickSave(Dialog dialog, String sEt) {
                        ...
                        Preference.getInstance(getContext()).setValueString(Preference.KEY_TRACE_NO_EPS, String.valueOf(Integer.valueOf(sEt)));
                        dialog.dismiss();
                    }
            ...
            case R.id.batchBtn:
                ...
                customDialog.setOnClickListener(new CustomDialog.OnClickDialog() {
                    ...
                    public void onClickSave(Dialog dialog, String sEt) {
                        ...
                        Preference.getInstance(getContext()).setValueString(Preference.KEY_BATCH_NUMBER_EPS, String.valueOf(Integer.valueOf(sEt)));
                        dialog.dismiss();
                    }
            ...
            case R.id.tpduBtn:
                ...
                customDialog.setOnClickListener(new CustomDialog.OnClickDialog() {
                    ...
                    public void onClickSave(Dialog dialog, String sEt) {
                        ...
                        Preference.getInstance(getContext()).setValueString(Preference.KEY_TPDU_EPS,sEt);
                        dialog.dismiss();
                    }
            ...
            case R.id.niiBtn:
                ...
                customDialog.setOnClickListener(new CustomDialog.OnClickDialog() {
                    ...
                    public void onClickSave(Dialog dialog, String sEt) {
                        ...
                        Preference.getInstance(getContext()).setValueString(Preference.KEY_NII_EPS,sEt);
                        dialog.dismiss();
                    }
