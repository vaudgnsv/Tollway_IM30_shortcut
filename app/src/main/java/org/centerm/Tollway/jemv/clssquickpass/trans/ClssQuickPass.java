package org.centerm.Tollway.jemv.clssquickpass.trans;
...
public class ClssQuickPass {
    ...
    private int clssReaderParameterSet() {
        ...
        szReaderParam.aucTmCap = str2Bcd("E0E8C8");
        ...
        szReaderParam.aucTmRefCurCode = new byte[]{(byte) 0x07, (byte) 0x64};

//        szReaderParam.aucTmCntrCode = new byte[]{(byte) 0x01, (byte) 0x56};
//        szReaderParam.aucTmTransCur = new byte[]{(byte) 0x01, (byte) 0x56};
//        szReaderParam.aucTmRefCurCode = new byte[]{(byte) 0x01, (byte) 0x56};
