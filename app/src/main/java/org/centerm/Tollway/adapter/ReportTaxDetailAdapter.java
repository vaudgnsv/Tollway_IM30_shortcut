...
//                cardAll.substring(4, 8) + " " + cardAll.substring(8, 12) + " " + cardAll.substring(12, 16));
        holder.cardLabel.setText( CardPrefix.maskviewcard(" ", taxList.get(position).getCardNo()));  // Paul_20190314 last 4 digts after 1111222233334444555 = 1111-2222-3XXX-XXX4-555
