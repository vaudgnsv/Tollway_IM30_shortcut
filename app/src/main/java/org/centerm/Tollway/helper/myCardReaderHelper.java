...
//            isStop = false;
//            isPause = false;
//            icc = TradeApplication.getDal().getIcc();
...
//                    piccInternal = TradeApplication.getDal().getPicc(EPiccType.INTERNAL);
//                }
//                // picc = piccInternal;
...
////                }
//                piccInternal.close();
//                //Activity.prnTime("polling piccInternal.open start timse = ");
//                piccInternal.open();
//                //Activity.prnTime("polling piccInternal.open timse = ");
//            }
//            if ((readerType.getEReaderType() & EReaderType.PICCEXTERNAL.getEReaderType()) == EReaderType.PICCEXTERNAL
//                    .getEReaderType()) {
//                // picc.close();
//                if (piccExternal == null) {
//                    piccExternal = TradeApplication.getDal().getPicc(EPiccType.EXTERNAL);
//                }
//                // picc = piccExternal;
//                piccExternal.close();
//                piccExternal.open();
//            }
//            ////Activity.prnTime("Device Open diff = ");
...
//                    ////Activity.prnTime("icc.detect start ");
//                    boolean ret = icc.detect(SLOT_ICC);
//                    ////Activity.prnTime("icc.detect diff = ");
//                    if (ret) {
//                        PollingResult result = new PollingResult();
//                        result.setOperationType(PollingResult.EOperationType.OK);
...
//
//                    ////Activity.prnTime("piccInternal.detect start ");
//                    //Activity.prnTime("piccInternal.detect start timse = ");
//                    PiccCardInfo info = piccInternal.detect(EDetectMode.EMV_AB);
//                    //Activity.prnTime("piccInternal.detect diff = ");
//                    if (info != null) {
//                        PollingResult result = new PollingResult();
//                        result.setOperationType(PollingResult.EOperationType.OK);
...
//    }
    ...
    public PollingResult polling(EReaderType readerType, int timeout) throws MagDevException, PiccDevException,
        ...
        isStop = false;
        isPause = false;
        icc = MainApplication.getDal().getIcc();
        byte mode = readerType.getEReaderType();
        mag = MainApplication.getDal().getMag();
//        if ((readerType.getEReaderType() & EReaderType.MAG.getEReaderType()) == EReaderType.MAG.getEReaderType()) {
//            mag = TradeApplication.getDal().getMag();
//            mag.close();
//            mag.open();
...
//        }
        ...
        if ((readerType.getEReaderType() & EReaderType.PICC.getEReaderType()) == EReaderType.PICC.getEReaderType()) {
            // picc.close();
            if (piccInternal == null) {
                piccInternal = MainApplication.getDal().getPicc(EPiccType.INTERNAL);
            }
            // picc = piccInternal;
//                if (readerType.getEReaderType() == EReaderType.PICC.getEReaderType()) {
//                    mag = TradeApplication.getDal().getMag();
...
//                }
        ...
        if ((readerType.getEReaderType() & EReaderType.PICCEXTERNAL.getEReaderType()) == EReaderType.PICCEXTERNAL
            ...
            // picc.close();
            if (piccExternal == null) {
                piccExternal = MainApplication.getDal().getPicc(EPiccType.EXTERNAL);
            }
            // picc = piccExternal;
            piccExternal.close();
            piccExternal.open();
