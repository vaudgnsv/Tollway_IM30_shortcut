...
import static org.centerm.Tollway.core.ChangeFormat.binStrToIntHexStr;
...
public class BlockCalculateUtil {
    ...
    public static String getHexString(String terminalNo) {
        ...
        char[] chars = terminalNo.toCharArray();
    ...
    public static String get35Data(String string) {
        ...
        //Jeff remove 20181024 [UL VISA Contactless Testcase 6,17]
        if(result.substring(result.length()-1).equals("F"))
    ...
    */
    ...
    public static String[] getReceivedDataBlock(String receivedData) {
        ...
        System.out.printf("utility:: Raw receivedData:" + receivedData + "\n");
    ...
    public static int getBlockLength(String receivedData, int blockIndex) {
        ...
        switch (blockIndex) {
            case (2 - 1):
                ...
                result = calculatePanLength(receivedData, 2);
                break;
            case (3 - 1):
                //n 6
                //PROCESSING CODE
    ...
    private static int calculatePanLength(String receivedData, int lengthBit) {
        int length = 0;
        if (receivedData == null) {
            return -1;
        }
    ...
    */
    ...
    public static String calculateApplicationData(String[] mBlockDatas) {
        ...
        Log.d("bitmap",hexBitmap.toString());
        ...
        for( int i=0; i<hex.length(); i++ ) {
            ...
            switch (output) {
                ...
                case " ":
                    ...
                    break;
                default:
                    String code = Integer.toHexString(output.charAt(0));
                    int decimal = Integer.parseInt(code, 16);

                    // System.out.println("Hex code to " + output + " = " + code);
    ...
    public static String getASCIIString(String terminalNo) {
        return String.format("%x", new BigInteger(1, terminalNo.getBytes(StandardCharsets.UTF_8)));
    }
}
